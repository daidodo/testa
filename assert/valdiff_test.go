...
func TestWriteDiffStringValue(t *testing.T) {
	eq := func(x1, x2 string, s1, s2 string) {
		...
		Caller(1).Equal(t, s1, d.String(0), "This is Message: %s\n%s", d.String(0), d.String(1))
		Caller(1).Equal(t, s2, d.String(1), "This is Message: %s\n%s", d.String(0), d.String(1))
	}
	eq("abcd", "accaa", "\"a\x1b[41mb\x1b[0mc\x1b[41m\"\x1b[0m", "\"a\x1b[41mc\x1b[0mc\x1b[41maa\"\x1b[0m")
