...
func TestWriteTypeDiffValues(t *testing.T) {
	...
	cs := []struct {
		...
		{v1: reflect.ValueOf(complex64(100.25 + 200.5i)), v2: reflect.ValueOf(complex64(101.25 + 200.5i)), s1: "(" + H("100.25") + "+200.5i)", s2: "(" + H("101.25") + "+200.5i)"},
		{v1: reflect.ValueOf(complex64(100.25 + 200.5i)), v2: reflect.ValueOf(complex64(100.25 + 201.5i)), s1: "(100.25+" + H("200.5i") + ")", s2: "(100.25+" + H("201.5i") + ")"},
		{v1: reflect.ValueOf(complex64(100.25 + 200.5i)), v2: reflect.ValueOf(complex64(101.25 + 201.5i)),
			s1: "(\x1b[41m100.25+200.5i\x1b[0m)",
			s2: "(\x1b[41m101.25+201.5i\x1b[0m)"},
		{v1: reflect.ValueOf(complex128(100.25 + 200.5i)), v2: reflect.ValueOf(complex128(101.25 + 200.5i)), s1: "(" + H("100.25") + "+200.5i)", s2: "(" + H("101.25") + "+200.5i)"},
		{v1: reflect.ValueOf(complex128(100.25 + 200.5i)), v2: reflect.ValueOf(complex128(100.25 + 201.5i)), s1: "(100.25+" + H("200.5i") + ")", s2: "(100.25+" + H("201.5i") + ")"},
		{v1: reflect.ValueOf(complex128(100.25 + 200.5i)), v2: reflect.ValueOf(complex128(101.25 + 201.5i)),
			s1: "(\x1b[41m100.25+200.5i\x1b[0m)",
			s2: "(\x1b[41m101.25+201.5i\x1b[0m)"},
		...
		{v1: reflect.ValueOf([8]int{}), v2: reflect.ValueOf([8]int{1: 10, 4: 20, 5: 30, 7: 40}),
			s1: "[0 \x1b[41m0\x1b[0m 0 0 \x1b[41m0 0\x1b[0m 0 \x1b[41m0\x1b[0m]",
			s2: "[0 \x1b[41m10\x1b[0m 0 0 \x1b[41m20 30\x1b[0m 0 \x1b[41m40\x1b[0m]"},
		{v1: reflect.ValueOf([8]complex128{}), v2: reflect.ValueOf([8]complex128{1: 10 + 1i, 4: 20 + 2i, 5: 30 + 3i, 7: 40 + 4i}),
			s1: "[(0+0i) (\x1b[41m0+0i\x1b[0m) (0+0i) (0+0i) (\x1b[41m0+0i\x1b[0m) (\x1b[41m0+0i\x1b[0m) (0+0i) (\x1b[41m0+0i\x1b[0m)]",
			s2: "[(0+0i) (\x1b[41m10+1i\x1b[0m) (0+0i) (0+0i) (\x1b[41m20+2i\x1b[0m) (\x1b[41m30+3i\x1b[0m) (0+0i) (\x1b[41m40+4i\x1b[0m)]"},
		...
		{v1: reflect.ValueOf(map[int][]int{1: []int{}, 2: nil, 3: nil}), v2: reflect.ValueOf(map[int][]int{1: []int{1, 2, 3}, 2: nil}),
			s1:  "map[int][]int{1:[], 2:<nil>, \x1b[41m3:<nil>\x1b[0m}",
			s2:  "map[int][]int{\n\t1:[\x1b[41m1 2 3\x1b[0m],\n\t2:<nil>\n}",
			ss1: "map[int][]int{2:<nil>, 1:[], \x1b[41m3:<nil>\x1b[0m}",
			ss2: "map[int][]int{\n\t2:<nil>,\n\t1:[\x1b[41m1 2 3\x1b[0m]\n}",
			n2:  true},
		...
		{v1: reflect.ValueOf(A{a: "中a文b", b: A{a: 101}}), v2: reflect.ValueOf(A{a: "a中文bc", b: A{a: 100}}),
			s1: "assert.A{\n\ta:\"\x1b[41m中a\x1b[0m文b\",\n\tb:{a:\x1b[41m101\x1b[0m b:<nil>}\n}",
			s2: "assert.A{\n\ta:\"\x1b[41ma中\x1b[0m文b\x1b[41mc\x1b[0m\",\n\tb:{a:\x1b[41m100\x1b[0m b:<nil>}\n}",
			n1: true, n2: true},
	}
	for i, c := range cs {
