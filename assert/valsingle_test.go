...
func TestWriteTypeValue(t *testing.T) {
	...
	a:0
		...
		{v: reflect.ValueOf(Chan(make(Chan))), e: "(assert.Chan)(%#x)", p: true},
		{v: reflect.ValueOf(Func(nil)), e: "(assert.Func)(nil)"},
		{v: reflect.ValueOf(Func(func(int) bool { return false })), e: "(assert.Func)(%#x)", p: true},
		{v: reflect.ValueOf(Ptr(nil)), e: "(assert.Ptr)(nil)"},
		{v: reflect.ValueOf(Ptr(new(int))), e: "(assert.Ptr)(%#x)", p: true},
		{v: reflect.ValueOf(UPtr(nil)), e: "(assert.UPtr)(nil)"},
		{v: reflect.ValueOf(UPtr(new(int))), e: "(assert.UPtr)(%#x)", p: true},
